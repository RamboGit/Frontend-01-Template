...
function layout(element) {
    ...
    if (style.alignContent === 'space-aroun') {
    ...
    flexLines.forEach(function (items) {
        var linecrossSize = style.alignContent === 'strench'?
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if(itemStyle[crossSize] === null) 
                    itemStyle[crossSize] = (align === 'stretch') ?
                        linecrossSize : 0;
                if(align === 'flex-start') {
                    itemStyle[crossStart] = crossSpace;
                    itemStyle[crossEnd] = itemStyle[crossStart] + crossSign * itemStyle[crossSpace];
                }
